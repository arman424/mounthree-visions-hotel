...
const roomsData = [
    ...
    },
    {
        ...
        images: ["images/standard-countryard1.jpeg", "images/standard-countryard2.jpeg", "images/standard-countryard3.jpeg", "images/standard-countryard4.jpeg", "images/standard-countryard5.jpeg", "images/standard-countryard6.jpeg"],
    ...
    },
    {
        ...
        images: ["images/standardTwin2.jpeg", "images/standardTwin3.jpeg", "images/standardTwin4.jpeg", "images/standardTwin5.jpeg", "images/standardTwin6.jpeg"],
    ...
    },
    {
        ...
        images: ["images/delux-forest1.jpeg", "images/delux-forest2.jpeg", "images/delux-forest3.jpeg", "images/delux-forest4.jpeg", "images/delux-forest5.jpeg", "images/delux-forest6.jpeg", "images/delux-forest7.jpeg", "images/delux-forest8.jpeg", "images/delux-forest9.jpeg", "images/delux-forest10.jpeg", "images/delux-forest11.jpeg"],
    ...
    },
    {
        ...
        images: ["images/delux-2room1.jpeg", "images/delux-2room2.jpeg", "images/delux-2room3.jpeg", "images/delux-2room4.jpeg", "images/delux-2room5.jpeg", "images/delux-2room6.jpeg", "images/delux-2room7.jpeg"],
    ...
    },
    {
        ...
        images: ["images/family1.jpeg", "images/family2.jpeg", "images/family3.jpeg", "images/family4.jpeg", "images/family5.jpeg", "images/family6.jpeg"],
        guests: 4, bathrooms: 1, area: "43-63 m²", qty: 3, price: "98,000֏",
        featureKeys: ["kingBedComfort", "privateEntrance", "elegantSofa", "balconyViewsBeautiful"] as const,
    },
    {
        nameKey: "signatureSuite" as const,
        images: ["images/signature-lux4.jpeg", "images/signature-lux2.jpeg", "images/signature-lux3.jpeg", "images/signature-lux5.jpeg", "images/signature-lux6.jpeg", "images/signature-lux7.jpeg", "images/signature-lux8.jpeg", "images/signature-lux9.jpeg", "images/signature-lux10.jpeg", "images/signature-lux11.jpeg", "images/signature-lux12.jpeg", "images/signature-lux13.jpeg", "images/signature-lux14.jpeg", "images/signature-lux15.jpeg", "images/signature-lux16.jpeg", "images/signature-lux17.jpeg", "images/signature-lux18.jpeg", "images/signature-lux19.jpeg", "images/signature-lux20.jpeg", "images/signature-lux21.jpeg", "images/signature-lux22.jpeg"],
    ...
    },
    {
        ...
        images: ["images/lux1.jpeg", "images/lux2.jpeg", "images/lux3.jpeg", "images/lux4.jpeg", "images/lux5.jpeg"],
    ...
    },
    {
        ...
        images: ["images/presidental.jpeg", "images/presidental2.jpeg", "images/presidental3.jpeg", "images/presidental4.jpeg", "images/presidental5.jpeg", "images/presidental6.jpeg", "images/presidental7.jpeg", "images/presidental8.jpeg", "images/presidental9.jpeg", "images/presidental10.jpeg", "images/presidental11.jpeg", "images/presidental12.jpeg"],
    ...
    },
    {
        ...
        images: ["images/shale.jpeg", "images/shale1.jpeg", "images/shale2.jpeg", "images/shale3.jpeg", "images/shale4.jpeg", "images/shale5.jpeg", "images/shale6.jpeg", "images/shale7.jpeg", "images/shale8.jpeg", "images/shale9.jpeg"],
    ...
    },
    {
        ...
        images: ["images/2shale1.jpeg", "images/2shale2.jpeg", "images/2shale3.jpeg", "images/2shale4.jpeg", "images/2shale5.jpeg", "images/2shale6.jpeg", "images/2shale7.jpeg", "images/2shale8.jpeg"],
                                ...
                                <Carousel className="w-full group" opts={{loop: true}}>
                                    <CarouselContent>
                                        {room.images.map((img, i) => (
                                            <CarouselItem key={i}>
                                                <img src={img} alt={`${t.roomsPage.roomNames[room.nameKey]} ${i + 1}`}
                                                     className="w-full aspect-[3/2] object-cover" loading="lazy"/>
                                            </CarouselItem>
                                        ))}
                                    </CarouselContent>
                                    <CarouselPrevious
                                        className="left-2 h-8 w-8 opacity-0 group-hover:opacity-100 transition-opacity bg-background/60 border-0 hover:bg-background/80"/>
                                    <CarouselNext
                                        className="right-2 h-8 w-8 opacity-0 group-hover:opacity-100 transition-opacity bg-background/60 border-0 hover:bg-background/80"/>
                                </Carousel>
                            </div>
